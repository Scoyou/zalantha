  ...
  return (
    <div className="flex flex-col items-center text-center p-4 bg-parchment min-h-screen">
      ...
      <p>
        ...
        up at least once after each event. Here&apos;s how the point system
        works: each limb hit counts as one point, while a chest hit counts as
        two points. Intentional head hits are strictly prohibited; doing so will
        ...
        upon arrival. Rules of Magica: The magic in this world is categorized
        into two types: Divine and Arcane. Divine Magic is primarily supportive,
        including abilities like healing and shielding. This form of magic is
        typically used by Warpriests. Arcane Magic is offensive, encompassing
        elemental magics like Fireball or Lightning Bolt, commonly wielded by
        Mages. Magic usage involves rolling a large D20 to determine success or
