export const Header = () => {
    return (
        <header>
            <div className="w-full bg-cover bg-center" style={{ height: '40rem', backgroundImage: 'url(https://cdn.midjourney.com/08247bbf-ba55-4945-a811-c141998935dd/0_2.webp)', backgroundSize: 'cover' }}>
