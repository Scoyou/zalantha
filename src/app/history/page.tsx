...
export default function History() {
  return (
    <Layout variant="dark" className="lore-panel">
      <BackgroundImage
      ...
      <Reveal>
        <div className="items-center text-center">
          <h1 className="heading-sigil text-3xl text-mist">History</h1>
      ...
      <div className="reading-flow">
        <Reveal delay={0.05}>
          <h2 className="heading-sigil text-2xl text-mist">
        ...
        <Reveal delay={0.15}>
          <blockquote className="pull-quote">
            Your choices and adventures will shape the future of Zalantha.
          </blockquote>
        </Reveal>
        <Reveal delay={0.2}>
          <h2 className="heading-sigil text-2xl text-mist">
