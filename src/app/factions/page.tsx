...
const races = [
  ...
  },
  {
    ...
    title: "Dwarves",
    content:
      "The Dwarves are humble miners who dwell in carved huts on the sides of the very mountains they mine. They collect jewels and precious metals, creating great weapons and jewelry from their finds. Dwarves love to celebrate after a hard day's work, hosting grand feasts as a large clan.",
  },
  {
    ...
    title: "Beastfolk",
    content:
      "Beastfolk have no land to call their own. Other factions view them as evil due to their appearance, forcing them to live as exiles, struggling to survive in a cruel and unforgiving world.",
  },
  {
    ...
    title: "Humans",
    content:
      "Humans have established villages and congregate together for safety, maintaining a sense of community in this harsh land. Their dialects and cultures can vary significantly.",
  },
  {
    ...
    title: "Faefolk",
    content:
      "The Faefolk reside deep in the woods, making their homes in trees, bushes, and near ponds. The most playful of all the factions, Faefolk are known to be pranksters. Their culture revolves around freedom in the forest and living in harmony with the animals.",
  },
  {
    ...
    title: "Elves",
    content:
      "Elves, who also love the forest, build their huts high in the trees to avoid predators. Living the longest among the factions, they prefer to take life slowly, savoring every moment. Elves are keen on learning about the world and dedicate themselves to its study.",
  },
];
